...
namespace ERPAutomation.Features
{
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Login user as Utitlity role user")]
        [NUnit.Framework.CategoryAttribute("utility-login")]
        public virtual void LoginUserAsUtitlityRoleUser()
        {
            string[] tagsOfScenario = new string[] {
                    "utility-login"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Login user as Utitlity role user", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
